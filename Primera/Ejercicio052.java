/*
 Implementar una función que sume los elementos de un vector unidimensional 
 de enteros y devuelva un entero con la suma.
 Desde el programa principal llamaremos a esta función una vez por cada empleado
 y mostraremos su nombre y la suma de sus salarios.
 */
package Primera;
